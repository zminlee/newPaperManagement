                     ...
                     <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="height: 100%">
                         ...
                         <div class="panel panel-default" id="Message">
                             ...
                             <div id="collapseFour" class="panel-collapse collapse in">
                                 <ul class="list-group">
                                     <li class="list-group-item">未读消息<span class="badge pull-right" id="UnReadNumber"></span></li>
                                     <li class="list-group-item" onclick="SendWebSocket()">已读消息</li>
                                 </ul>
                             </div>
                         </div>
                         <%--<div class="panel panel-default" id="Message">--%>
                     ...
                     <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                          <div class="panel panel-default" style="height: 30%;width: 100%;margin-bottom: 0px">
                                 <div class="panel-body">
                                     ...
                                     <label class="control-label label_h2" style="width: 30%">发送消息选择用户：</label>
