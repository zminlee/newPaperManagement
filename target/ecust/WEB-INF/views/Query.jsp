                ...
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                        <div class="panel panel-default" style="height: 70%;width: 100%;margin-bottom: 0px">
                            <div class="panel-body" style="height: 10%;width: 100%;margin-bottom: 0px;float:left">
                                <label class="control-label label_h2" style="float:left;margin-right: 20px">选择文献</label>
                                <input type="file" style="float:left;margin-right: 30px;border:1px solid #4876FF" value="选择文献">
                                <button class="btn btn-success fileinput-button" type="button" style="float:left">确定</button>
                            </div>
                            <div style="height: 90%;width: 65%;resize: none;float:left;margin-right: 20px">
                                <textarea style="width:100%; height:100%" class="form-control"   placeholder="文献内容" onfocus="ChangeFocus()"></textarea>
                            </div>
                            <div style="height: 90%;width: 30%;resize: none;float:left">
                                <div style="height: 30%;width: 100%;resize: none">
                                    <textarea style="width:100%; height:90%" class="form-control"   placeholder="关键词" onfocus="ChangeFocus()"></textarea>
                                </div>
                                <div style="height: 70%;width: 100%;resize: none">
                                    <textarea style="width:100%; height:100%" class="form-control"   placeholder="批注" onfocus="ChangeFocus()"></textarea>
                                </div>
                            </div>
                        </div>
